...
{
    public class TyphoonProjectile : Projectile
    {
        private static Texture2D _defaultTexture;

        // Переменная отвечающая за скорость поворота спрайта - ПРОТИВ часовой стрелки (как у золотого тайфуна)
        private const float ROTATION_SPEED = -1080f; // Огромная скорость вращения влево
        ...
        public TyphoonProjectile(Vector2 position, int size, Color color, int damage, float speed, Vector2 target, float lifetime)
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            // Вращаем ПРОТИВ часовой стрелки с огромной скоростью (как у золотого тайфуна)
