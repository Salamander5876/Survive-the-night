...
Проект лицензирован под MIT и доступен на GitHub: [github.com/yourusername/survive-the-night](https://github.com/yourusername/survive-the-night) (замените на реальный URL).
