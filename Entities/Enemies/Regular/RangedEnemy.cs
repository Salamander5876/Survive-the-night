...
namespace Survive_the_night.Entities.Enemies.Regular
{
    ...
    {
        public RangedEnemy(Vector2 initialPosition, Player playerTarget, int stage, DifficultyManager difficultyManager)
            : base(initialPosition, playerTarget, 4, 70f, Color.Purple, 8, stage, difficultyManager)
        {
            Damage = CalculateDamageForStage(8, stage);
            speed = CalculateSpeedForStage(70f, stage);
        }

        public RangedEnemy(Vector2 initialPosition, Player playerTarget)
